...
INSERT INTO "new_StudentProfile" ("createdAt", "currentTerm", "displayName", "entryYear", "gpaScale", "id", "includeFailInAvg", "themeColor", "updatedAt", "userId") SELECT "createdAt", "currentTerm", "displayName", "entryYear", "gpaScale", "id", "includeFailInAvg", "themeColor", "updatedAt", "userId" FROM "StudentProfile";
